...
insert into public.episode_section_paragraphs (
  ...
  ($$episode-3-insomnia$$, 30, 10, $$Discusses blue-light strategies, evening habits, morning light and daytime exercise, and cautious use of melatonin and homeopathic options, with current product-guide links collected in the episode resources.$$),
  ...
  ($$episode-4-emf$$, 30, 10, $$Practical reduction strategies: hardwiring, nighttime WiFi habits, meter-based assessment, smart-meter choices, and current links collected in the episode resources and product guide.$$),
...
insert into public.affiliate_product_episode_links (product_slug, episode_slug, link_reason) values
  ...
  ('desbio-dbscript', 'episode-3-insomnia', 'DesBio sleep-support products named in Episode 3'),
