...
const platforms: Platform[] = [
  {
    name: "YouTube",
    url: "https://www.youtube.com/channel/UCFA1nVv4lKMBlx81gjMAOFQ",
    icon: (
  ...
  {
    name: "Spotify",
    url: "https://open.spotify.com/show/7GGLljxmO0G3FLjPy8vfcw",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    name: "Rumble",
    url: "https://rumble.com/c/c-7820170",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  {
    name: "TikTok",
    url: "https://www.tiktok.com/@drmexperienced",
    icon: (
